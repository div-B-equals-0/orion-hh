...
#+begin_src python 
  ...
  hdu5007, = fits.open(datadir / "linesum-O_III-5007.fits")
  hdu4650, = fits.open(datadir / "O_II-V1-4649-51-sum.fits")
  hdu4640, = fits.open(datadir / "O_II-V1-4639-42-sum.fits")
  fits.PrimaryHDU(
      header=hdu4650.header,
      data=hdu4650.data/hdu5007.data
  ).writeto(datadir / "O_II-V1-4649-51-over-5007.fits", overwrite=True)
  fits.PrimaryHDU(
      header=hdu4640.header,
      data=hdu4640.data/hdu5007.data
  ).writeto(datadir / "O_II-V1-4639-42-over-5007.fits", overwrite=True)
#+end_src
