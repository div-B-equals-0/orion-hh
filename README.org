...
#+header: :var STRETCH=0.9 Q=2.5 WINDOW=window-1996
#+begin_src python :results file :return figfile :tangle rgb-lupton-hh529.py
  ...
  regions = rg.read_ds9("hh529-iii-slit.reg")
...
+ For the O II lines, we need to isolate the 4649 blens
...
#+header: :var SUFFIX="-coarse-2e9-1p5"
#+begin_src python 
  import sys
  import numpy as np
  from astropy.io import fits
  ...
  hdu5007, = fits.open(datadir /  f"linesum-O_III-5007-multibin{SUFFIX}.fits")
  hdu4650, = fits.open(datadir / f"O_II-V1-4649-51-sum-multibin{SUFFIX}.fits")
  hdu4640, = fits.open(datadir / f"O_II-V1-4639-42-sum-multibin{SUFFIX}.fits")
  hdu4631, = fits.open(datadir / f"N_II-4631-sum-multibin{SUFFIX}.fits")
  hdu4634, = fits.open(datadir / f"N_III-4634-sum-multibin{SUFFIX}.fits")

  fits.PrimaryHDU(
      header=hdu4650.header,
      data=hdu4650.data/hdu5007.data
  ).writeto(datadir / f"O_II-V1-4649-51-over-5007-multibin{SUFFIX}.fits", overwrite=True)
  fits.PrimaryHDU(
      header=hdu4640.header,
      data=hdu4640.data/hdu5007.data
  ).writeto(datadir / f"O_II-V1-4639-42-over-5007-multibin{SUFFIX}.fits", overwrite=True)
  fits.PrimaryHDU(
      header=hdu4650.header,
      data=hdu4650.data/hdu4640.data
  ).writeto(datadir / f"O_II-V1-4649-51-over-4639-42-multibin{SUFFIX}.fits", overwrite=True)
  ...
  fits.PrimaryHDU(
      header=hdu4640.header,
      data=hdu4640.data/hdu5007.data
  ).writeto(datadir / f"O_II-V1-4639-42-minus-N_II_III-over-5007-multibin{SUFFIX}.fits", overwrite=True)
  fits.PrimaryHDU(
      header=hdu4650.header,
      data=hdu4650.data/hdu4640.data
  ).writeto(datadir / f"O_II-V1-4649-51-over-4639-42-minus-N_II_III-multibin{SUFFIX}.fits", overwrite=True)
