...
#+end_src
#+begin_src sh :results silent
  python muse/multibin-combine.py O_II-V1-4649-51-sum 5e8 1.5
#+end_src

#+begin_src sh :results silent
  python muse/multibin-combine.py O_II-V1-4639-42-sum 5e8 1.5
#+end_src

#+begin_src sh :results silent
  python muse/multibin-combine.py N_III-4634-sum 5e8 1.5
#+end_src

#+begin_src sh :results silent
  python muse/multibin-combine.py N_II-4631-sum 5e8 1.5
#+end_src

#+begin_src sh :results silent
  python muse/multibin-combine.py linesum-O_III-5007 5e8 1.5
#+end_src
...
*** TODO Subtract the N II and N III contamination from 4639-42 image
...
#+begin_src python 
  ...
  hdu5007, = fits.open(datadir / "linesum-O_III-5007-multibin.fits")
  hdu4650, = fits.open(datadir / "O_II-V1-4649-51-sum-multibin.fits")
  hdu4640, = fits.open(datadir / "O_II-V1-4639-42-sum-multibin.fits")
  fits.PrimaryHDU(
      header=hdu4650.header,
      data=hdu4650.data/hdu5007.data
  ).writeto(datadir / "O_II-V1-4649-51-over-5007-multibin.fits", overwrite=True)
  fits.PrimaryHDU(
      header=hdu4640.header,
      data=hdu4640.data/hdu5007.data
  ).writeto(datadir / "O_II-V1-4639-42-over-5007-multibin.fits", overwrite=True)
  fits.PrimaryHDU(
      header=hdu4650.header,
      data=hdu4650.data/hdu4640.data
  ).writeto(datadir / "O_II-V1-4649-51-over-4639-42-multibin.fits", overwrite=True)
#+end_src
