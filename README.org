...
#+begin_src python :results file :return figfile
  ...
  R = (Soiii - bg_oiii) / (Sha - bg_ha)
  R_bg = bg_oiii / bg_ha

  figfile = f"{ID}-oiii-ha-ratio.pdf"
  fig, ax = plt.subplots()
  ax.plot(x[IBG:] - x[ishock], R[IBG:])
  ax.axhline(R_bg, linestyle="--")
  ax.set(ylim=[0.0, 0.7], xlabel="Displacement, pixels", ylabel="[O III] / Ha")
  sns.despine()
  fig.tight_layout()
  fig.savefig(figfile)
#+end_src
...
#+call: hh204-plot-ratio(ID="hh204-uves-slit", IBG=75)

#+RESULTS:
[[file:hh204-uves-slit-oiii-ha-ratio.pdf]]


#+call: hh204-plot-ratio(ID="hh204-wide-slit", IBG=40)

#+RESULTS:
[[file:hh204-wide-slit-oiii-ha-ratio.pdf]]
