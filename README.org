...
#+begin_src python :return figfile :results file
  ...
  im = ax.imshow(hdu.data, vmin=0.0, vmax=0.60, cmap="gray")
...
+ This time, I do not subtrat the upstream BG from the shock regions, since I am interested in the fraction of all the emission in each line that comes from the blue-shifted component
